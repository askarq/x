Action()
{
	...
	lr_start_transaction("UC_04_Create_Accounts");
	...
	web_submit_data("login.pl", 
		...
		"Name=passwordConfirm", "Value=bean3", ENDITEM, 
	...
	web_submit_data("login.pl_2", 
		...
		"Mode=HTML", 
		ITEMDATA, 
		"Name=userSession", "Value=129607.831915755zzzzHAcpiftVzzzHtAAAApcVHVcf", ENDITEM, 
		"Name=username", "Value=jojo3", ENDITEM, 
		"Name=password", "Value=bean3", ENDITEM, 
	...
	lr_start_transaction("click_flnd_flight");
	...
	lr_end_transaction("click_flnd_flight",LR_AUTO);
	...
	lr_end_transaction("UC_04_Create_Accounts",LR_AUTO);
